...
class MoreAvatarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        avatarImage_1.snp.makeConstraints { make in
            make.leading.equalTo(self.view.snp.leading).inset(45)
            make.trailing.equalTo(self.view.snp.trailing).inset(45)
        ...
        avatarImage_2.snp.makeConstraints { make in
            ...
            make.top.equalTo(self.avatarImage_1.snp.bottom).offset(10)
            make.height.equalTo(100)
        }
